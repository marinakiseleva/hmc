...
class TestMetrics(unittest.TestCase):
    ...
    def test_precision_score_ancestors(self):
        ...
        precision_sk = skmetrics.precision_score(self.y_test, self.y_pred)
    ...
    def test_recall_score_ancestors(self):
        ...
        recall_sk = skmetrics.recall_score(self.y_test, self.y_pred)
    ...
    def test_f1_score_ancestors(self):
        ...
        f1_sk = skmetrics.f1_score(self.y_test, self.y_pred)
